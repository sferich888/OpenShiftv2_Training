...
<body>
 ...
 <section class='container'>
          <hgroup>
            <h1>Welcome to the OpenShift Basics Training using JBoss EAP on OpenShift Enterprise</h1>
          </hgroup>
        ...
        <div class="row">
          ...
          <section class="col-xs-12 col-sm-6 col-md-6">
                ...
                <p>The VM you are using should have the <a href="https://www.openshift.com/developers/rhc-client-tools-install">OpenShift RHC client tools</a> installed, please refer to the <a href="https://www.openshift.com/user-guide">User Guide</a> to learn more on how to manage your application from the command line.
                </p>
